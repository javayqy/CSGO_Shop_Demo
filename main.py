...
while True:
    ...
    steamLowPrice_US = round(float(steamLowPrice) / 7.2, 2)
    ...
    print("steam最低价格(人民币):" + steamLowPrice + "  steam最低价格(美元):" + str(steamLowPrice_US))
    print("buff最低价格(人民币）：" + str(buffLowPrice_CNY) + "  buff最低价格(美元)（美元）" + str(buffLowPrice_USD))
